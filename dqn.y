...
Explore
 @gupta158 Sign out
1,357
14,867 3,972 Microsoft/CNTK
 Code  Issues 502  Pull requests 54  Wiki  Insights
CNTK/Examples/ReinforcementLearning/DeepQNeuralNetwork.py
f1d6fc9  on Nov 13, 2017
@tangyuq tangyuq Updated examples and tests with new Learning APIs.
@wilrich-msft @tangyuq
     
481 lines (374 sloc)  17.6 KB
